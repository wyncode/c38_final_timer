          ...
          <MDBCol lg="7">
            <MDBRow className="mb-3">
              ...
              <MDBCol xl="10" md="11" size="10">
                ...
                <p className="grey-text">
                  Whether you need a Default, the much raved about Pomodoro, or your own Custom timer, 
            ...
            <MDBRow className="mb-3">
              ...
              <MDBCol xl="10" md="11" size="10">
                ...
                <p className="grey-text">
                  We made this web app because because we know you've got better stuff to do. 
                  Nothing fancy, just you, this timer and your task. 
                </p>
              </MDBCol>
            </MDBRow>
            <MDBRow className="mb-3">
              ...
              <MDBCol xl="10" md="11" size="10">
                ...
                <p className="grey-text">
                  The WynIt team does just that. Each member brings a unique set of skills,
                   the combination of which gave you this app!
                </p>
